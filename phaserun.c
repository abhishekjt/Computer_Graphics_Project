...
void menu()
{
	char str1[]="Illustrating Phases of a day";
	char str11[]="with Moving car";
	...
	char str8[]="q-quit";
	char str6[]="-project done by \n Abhishek J\n& Nirupam Nagraj ";
	char str7[]="Under the Guidence of Asst Prof. Aparna ";
	glClearColor(0,0,0,0);
	glClear(GL_COLOR_BUFFER_BIT);
	glColor3f(1,0,0);
	drawText(300,400,str1);
	drawText(375,375,str11);
	drawText(300,350,str6);
	drawText(300,325,str7);
